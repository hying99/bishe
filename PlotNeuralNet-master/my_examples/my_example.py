...
arch = [
    ...
    to_LinearRelu("linear1",'z', 4096 ,"(1.2,0,0)", "(conv2-east)", caption="Flatten", width=1.5, height=2,depth=60),


    to_Linear("linear2", 'z',512, "(1.2,0,0)", "(linear1-east)", width=1.5, height=3, depth=16, caption="Linear"),
    to_SoftMax("soft", 4 ,"(1.2,0,0)", "(linear2-east)", caption="LogSoftMax", depth=4  ),
