...
/* 107 */       ClusDecisionTree clusDecisionTree; sett.setDate(new Date());
...
/*     */     }  } private void activeRun() throws IOException, ClusException, ClassNotFoundException, Exception { RandomSamplingHSC randomSamplingHSC;
...
/* 155 */           QueryByCommitteeHSC queryByCommitteeHSC = new QueryByCommitteeHSC(this.m_Clus, settings.getActiveAlgorithm()); break;
/*     */         } 
...
/* 162 */           QueryByCommitteeHierarchyNoLevelHSC queryByCommitteeHierarchyNoLevelHSC = new QueryByCommitteeHierarchyNoLevelHSC(this.m_Clus, settings.getActiveAlgorithm()); break;
/*     */         } 
...
/* 360 */         SparseDataTuple sparseDataTuple; ClassesTuple clss = new ClassesTuple(1);
...
/* Location:              C:\Users\1231\Desktop\dataprocessing\activelearning\Clus-AL\Clus-AL\ClusAL\!\addon\hmc\HMCNodeWiseModels\hmcnwmodels\HSC.class
