...
public class ChiSquaredAttributeEval extends AttributeEvaluator implements OptionHandler {
  ...
  public void buildEvaluator(Instances paramInstances) throws Exception {
    ...
    this.m_ChiSquareds = new double[paramInstances.numAttributes()];
    for (b2 = 0; b2 < paramInstances.numAttributes(); b2++) {
      if (b2 != i)
        this.m_ChiSquareds[b2] = ContingencyTables.chiVal(ContingencyTables.reduceMatrix(arrayOfDouble[b2]), false); 
    } 
  }
  ...
  public double evaluateAttribute(int paramInt) throws Exception {
    return this.m_ChiSquareds[paramInt];
  }
  ...
  public static void main(String[] paramArrayOfString) {
    try {
      System.out.println(AttributeSelection.SelectAttributes(new ChiSquaredAttributeEval(), paramArrayOfString));
...
/* Location:              C:\Users\1231\Desktop\dataprocessing\activelearning\Clus-AL\Clus-AL\ClusAL\!\jars\weka.jar!\weka\attributeSelection\ChiSquaredAttributeEval.class
