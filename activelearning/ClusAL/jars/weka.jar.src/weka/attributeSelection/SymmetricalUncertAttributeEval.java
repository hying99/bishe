...
public class SymmetricalUncertAttributeEval extends AttributeEvaluator implements OptionHandler {
  ...
  public double evaluateAttribute(int paramInt) throws Exception {
    ...
    return ContingencyTables.symmetricalUncertainty(arrayOfDouble);
  }
  ...
  public static void main(String[] paramArrayOfString) {
    try {
      System.out.println(AttributeSelection.SelectAttributes(new SymmetricalUncertAttributeEval(), paramArrayOfString));
...
/* Location:              C:\Users\1231\Desktop\dataprocessing\activelearning\Clus-AL\Clus-AL\ClusAL\!\jars\weka.jar!\weka\attributeSelection\SymmetricalUncertAttributeEval.class
