...
public class DNConditionalEstimator implements ConditionalEstimator {
  ...
  public DNConditionalEstimator(int paramInt, double paramDouble) {
  ...
  public String toString() {
    null = "DN Conditional Estimator. " + this.m_Estimators.length + " sub-estimators:\n";
    for (byte b = 0; b < this.m_Estimators.length; b++)
  ...
  public static void main(String[] paramArrayOfString) {
    try {
      ...
      DNConditionalEstimator dNConditionalEstimator = new DNConditionalEstimator(j + 1, 1.0D);
      for (byte b2 = 0; b2 < paramArrayOfString.length - 1; b2 += 2) {
        ...
        System.out.println("Prediction for " + i + '|' + k + " = " + dNConditionalEstimator.getProbability(i, k));
        dNConditionalEstimator.addValue(i, k, 1.0D);
      } 
...
/* Location:              C:\Users\1231\Desktop\dataprocessing\activelearning\Clus-AL\Clus-AL\ClusAL\!\jars\weka.jar!\weka\estimators\DNConditionalEstimator.class
