...
public class KDConditionalEstimator implements ConditionalEstimator {
  ...
  public KDConditionalEstimator(int paramInt, double paramDouble) {
  ...
  public String toString() {
    String str = "KD Conditional Estimator. " + this.m_Estimators.length + " sub-estimators:\n";
  ...
  public static void main(String[] paramArrayOfString) {
    try {
      ...
      KDConditionalEstimator kDConditionalEstimator = new KDConditionalEstimator(m + 1, 1.0D);
      for (byte b2 = 0; b2 < paramArrayOfString.length - 1; b2 += 2) {
        ...
        System.out.println(kDConditionalEstimator);
        System.out.println("Prediction for " + i + '|' + k + " = " + kDConditionalEstimator.getProbability(i, k));
        kDConditionalEstimator.addValue(i, k, 1.0D);
      } 
...
/* Location:              C:\Users\1231\Desktop\dataprocessing\activelearning\Clus-AL\Clus-AL\ClusAL\!\jars\weka.jar!\weka\estimators\KDConditionalEstimator.class
