  ...
  public static void main(String[] paramArrayOfString) {
    try {
      if (Utils.getFlag('b', paramArrayOfString)) {
        Filter.batchFilterFile(new RemoveFolds(), paramArrayOfString);
      } else {
        Filter.filterFile(new RemoveFolds(), paramArrayOfString);
      } 
...
/* Location:              C:\Users\1231\Desktop\dataprocessing\activelearning\Clus-AL\Clus-AL\ClusAL\!\jars\weka.jar!\weka\filter\\unsupervised\instance\RemoveFolds.class
