...
# input x,y
a = '5'
x_traindata = np.array(pd.read_csv(("C:/Users/1231/Desktop/dataprocessing/data/204dataset"+a+"/traindataset.csv"),header=None))
#x_traindata = np.repeat(x_train, repeats=4, axis=0)
...
#y_traindata = y_traindata.reshape(-1,1,204)

x_validdata = np.array(pd.read_csv(("C:/Users/1231/Desktop/dataprocessing/data/204dataset"+a+"/validdataset.csv"),header=None))
#x_validdata = np.repeat(x_valid, repeats=4, axis=0)
...
#y_validdata = y_validdata.reshape(-1,1,204)

x_testdata= np.array(pd.read_csv(("C:/Users/1231/Desktop/dataprocessing/data/204dataset"+a+"/testdataset.csv"),header=None))
#x_testdata = np.repeat(x_test, repeats=4,axis=0)
...
#y_testdata = y_testdata.reshape(-1,1,204)
...
np.savetxt(('nn'+a+'.csv'), predict_labels, delimiter = ',')
np.savetxt(('nn'+a+'prob.csv'),predict_scores,delimiter=',') 
# Creates a HDF5 file 'lstm_genre_classifier.h5'

model_filename = "nn.h5py"
